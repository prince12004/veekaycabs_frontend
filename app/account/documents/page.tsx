...
import { CheckCircle, AlertCircle, Loader2, RefreshCw, Calendar } from "lucide-react";
...
// ─── Polished date picker: icon-prefixed, formatted display, native picker ────
// Relies on HTMLInputElement.showPicker() (Chrome/Edge 99+) to open the native
// calendar reliably from a click anywhere in the field — the older "transparent
// input on top" trick only opens the picker when clicking exactly on the
// browser's tiny calendar-icon hit area, not the rest of the field.
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        disabled={disabled}
        className={cn(
          "w-full border-[1.5px] border-[#E4E5EF] focus:border-[#E8540A] rounded-xl pl-10 pr-4 py-2.5 text-sm flex items-center text-left transition-colors relative",
      ...
      >
        ...
        {formatted || <span className="text-[#9090A8]">Select date</span>}
      </button>
    </div>
  );
}
                ...
                <div className="bg-white rounded-2xl border border-[#E4E5EF] shadow-[0_2px_20px_rgba(0,0,0,0.06)] p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-5">
                    ...
                    <div>
                      ...
                      <DateField value={dlValidity} onChange={setDlValidity} />
                    </div>
                  </div>
                  {dlStatus !== "verified" && (
                    <div className="flex gap-2 mb-5">
                      <div className="flex-1">
                        ...
                        <DateField value={dlDob} onChange={setDlDob} />
                      </div>
